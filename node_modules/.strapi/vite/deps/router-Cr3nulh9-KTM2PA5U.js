...
var ProtectedListPage = (0, import_react.lazy)(
  () => import("./index-CGmh3cED-IHZBZA54.js").then((mod) => ({ default: mod.ProtectedListPage }))
);
var ProtectedEditPage = (0, import_react.lazy)(
  () => import("./id-CtcCl3zh-7OWKFQHU.js").then((mod) => ({ default: mod.ProtectedEditPage }))
);
var routes = [
  {
    path: "/",
...
//# sourceMappingURL=router-Cr3nulh9-KTM2PA5U.js.map
